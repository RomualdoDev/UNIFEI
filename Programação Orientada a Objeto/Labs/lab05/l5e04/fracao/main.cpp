...
int main()
{
    ...
    cout<<fra1<<" como inteiro = "<<(int)fra1<<endl;
    cout<<fra2<<" como inteiro = "<<(int)fra2<<endl;
    cout<<fra1<<" como double = "<<(double)fra1<<endl;
    cout<<fra2<<" como double = "<<(double)fra2<<endl;
    cout<<fra1<<" como complexo = "<< (Complexo)fra1<<endl;
    cout<<fra2<<" como complexo = "<< (Complexo)fra2<<endl;
